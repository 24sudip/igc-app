                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li>
                                                <div class="searce-box">
                                                    <div class="logo-area">
                                                        <a href="{{ route('home') }}"><img src="{{ asset('frontend_assets/images') }}/logo-footer.png" alt="logo"></a>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
        ...
        <div class="footer-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-4 col-md-12">
                        ...
                        <div _ngcontent-twj-c48=""><iframe _ngcontent-twj-c48="" src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Figcbd&amp;tabs=timeline&amp;width=340&amp;height=270&amp;small_header=true&amp;adapt_container_width=true&amp;hide_cover=false&amp;show_facepile=true&amp;appId" width="340" height="270" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" style="border: none; overflow: hidden;"></iframe></div>
                </div>
                </div>
